...
export default function Symptoms() {
    return (
        <section className="px-6 py-16 bg-brand-deep-grey">
            ...
            <div className="space-y-6">
                {symptoms.map((item, i) => (
                    <Reveal key={item.text} delay={i * 60}>
                        <motion.div whileHover={{ x: 5, borderColor: "rgba(232, 193, 82, 0.4)" }} className="p-6 rounded-2xl bg-black/40 border border-primary/10 italic flex gap-4 transition-colors cursor-default">
